      ...
      <main>
        <div>
          ...
          <ReactCheatSheet data={data}>
            {({ name, categories, selectedCategories, filteredResults, handleCategoryChange, searchPredicate, handleSearchChange }) => (
              <div>
                <SearchInput searchPredicate={searchPredicate} handleSearchChange={handleSearchChange} />
